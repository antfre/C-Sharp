...
namespace Uppgift1b
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"17. sant = {sant}");
            ...
            Console.WriteLine($"\nTal1 = {tal1} \nTal2 = {tal2} \nProdukten av {tal1} och {tal2} är {tal1 * tal2}.");

            Console.WriteLine("\nTryck på en valfri tangent för att avsluta...");
            Console.ReadKey();
        }
    }
}